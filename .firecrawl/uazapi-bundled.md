      ...
      "Chat": {
        ...
        "properties": {
          ...
          "common_groups": {
            ...
            "default": "",
            "example": "Grupo Família(redacted@example.invalid),Trabalho(redacted@example.invalid)"
          },
          "lead_name": {
            "type": "string",
  ...
  "paths": {
    ...
    "/instance/proxy": {
              ...
              "schema": {
                ...
                "properties": {
                  ...
                  "proxy_url": {
                    ...
                    "example": "[REDACTED_BASIC_AUTH_URL]"
                  }
                },
                "required": [
                  "enable"
      ...
      "delete": {
        ...
        "description": "Desativa e apaga o proxy personalizado, voltando ao comportamento padrão (proxy interno).\nPode reiniciar a conexão para aplicar a remoção.\n",
        "security": [
          {
            "token": []
          }
    ...
    "/message/history-sync": {
      "post": {
        ...
        "responses": {
          "200": {
            "description": "Solicitação de history sync enviada com sucesso",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
          ...
          "400": {
            "description": "Payload inválido ou âncora insuficiente",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
          ...
          "500": {
            "description": "Erro interno ao solicitar o history sync",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "groupjid": {
                    "type": "string",
                    "description": "Identificador único do grupo (JID)\n- Formato: núredacted@example.invalid\n- Exemplo válido: redacted@example.invalid\n",
                    "example": "redacted@example.invalid",
                    "pattern": "^\\d+@g\\.us$"
                  }
                },
    ...
    "/group/list": {
      "get": {
        ...
        "description": "Retorna uma lista com todos os grupos disponíveis para a conta do WhatsApp atualmente conectada.\n\nRecursos adicionais:\n- Suporta atualização forçada do cache de grupos\n- Recupera informações detalhadas de grupos conectados\n",
        "parameters": [
          {
            "name": "force",
            "in": "query",
      ...
      "post": {
        ...
        "description": "Retorna uma lista com todos os grupos disponiveis para a conta do WhatsApp atualmente conectada, com opcoes de filtros e paginacao via corpo (POST).\nA rota GET continua para quem prefere a listagem direta sem paginacao.\n",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "groupjid": {
                    "type": "string",
                    "description": "Identificador único do grupo no formato redacted@example.invalid",
                    "example": "redacted@example.invalid"
                  },
                  "announce": {
                    "type": "boolean",
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "groupjid": {
                    "type": "string",
                    "description": "JID (ID) do grupo no formato redacted@example.invalid",
                    "example": "redacted@example.invalid",
                    "pattern": "^[0-9]+@g\\.us$"
                  },
                  "description": {
              ...
              "schema": {
                ...
                "properties": {
                  ...
                  "groupjids": {
                    ...
                    "items": {
                      "type": "string",
                      "pattern": "^[0-9]redacted@example.invalid$"
                    },
                    "minItems": 1,
    ...
    "/newsletter/list": {
      "get": {
        ...
        "description": "Retorna os canais/newsletters já inscritos pela conta do WhatsApp atualmente conectada.\n",
        "responses": {
          "200": {
    ...
    "/newsletter/info": {
      "post": {
        ...
        "description": "Busca os detalhes de um canal/newsletter pelo `id` numérico ou pelo `jid`.\n",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
    ...
    "/newsletter/admin/invite": {
      "post": {
        ...
        "description": "Convida um telefone para virar administrador do canal.",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
    ...
    "/newsletter/admin/accept": {
      "post": {
        ...
        "description": "Aceita um convite pendente de administrador do canal.",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
    ...
    "/newsletter/admin/revoke": {
      "post": {
        ...
        "description": "Revoga um convite pendente de administrador do canal usando o telefone do convidado.",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
        ...
        "parameters": [
          {
            ...
            "description": "Filtro de status desejado. O backend atual retorna todas as pastas do owner e\npode ignorar esse parâmetro dependendo da implementação da fila.\n"
          }
        ],
        "responses": {
          "200": {
                ...
                "schema": {
                  ...
                  "properties": {
                    "blockList": {
                      ...
                      "items": {
                        "type": "string",
                        "description": "JIDs dos contatos bloqueados no formato \"núredacted@example.invalid\""
                      },
                      "example": [
                        "redacted@example.invalid",
                        "redacted@example.invalid"
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "number": {
                    "type": "string",
                    "description": "Identificador do chat no formato:\n- Para usuários: [número]@s.whatsapp.net (ex: redacted@example.invalid)\n- Para grupos: [id-grupo]@g.us (ex: redacted@example.invalid)\n",
                    "example": "redacted@example.invalid"
                  },
                  "read": {
                    "type": "boolean",
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "number": {
                    "type": "string",
                    "description": "ID do chat no formato redacted@example.invalid ou redacted@example.invalid",
                    "example": "redacted@example.invalid"
                  },
                  "muteEndTime": {
                    "type": "integer",
                ...
                "schema": {
                  ...
                  "items": {
                    ...
                    "properties": {
                      "jid": {
                        "type": "string",
                        "description": "ID único do contato no WhatsApp (formato: núredacted@example.invalid)",
                        "example": "redacted@example.invalid"
                      },
                      "contactName": {
                        "type": "string",
                    ...
                    "contacts": {
                      ...
                      "items": {
                        ...
                        "properties": {
                          "jid": {
                            "type": "string",
                            "description": "ID unico do contato no WhatsApp (formato: redacted@example.invalid)",
                            "example": "redacted@example.invalid"
                          },
                          "contact_name": {
                            "type": "string",
                ...
                "examples": {
                  "contact_example": {
                    ...
                    "value": {
                      ...
                      "lead_email": "redacted@example.invalid",
                      "lead_status": "ativo",
                      "wa_contactName": "João Silva",
                      "common_groups": "Grupo Família(redacted@example.invalid),Trabalho(redacted@example.invalid)",
                  ...
                  "group_example": {
                    ...
                    "value": {
                      "id": "r9z8y7x6w5v4u3",
                      "wa_fastid": "admin:redacted@example.invalid",
                      "wa_chatid": "redacted@example.invalid",
    ...
    "/labels/refresh": {
      "post": {
        ...
        "summary": "Recarregar etiquetas do WhatsApp",
        "description": "Faz uma nova leitura das etiquetas no WhatsApp antes de retornar a lista atualizada.\n\nUso recomendado:\n- tente primeiro com `force=false`\n- se isso não trouxer as etiquetas corretamente, tente `force=true`\n- use `force=true` apenas como tentativa de correção, porque ele faz uma recarga mais pesada\n",
        "requestBody": {
          "required": false,
          "content": {
            "application/json": {
        ...
        "responses": {
          "200": {
            "description": "Lista de etiquetas recarregada com sucesso",
            "content": {
              "application/json": {
                "schema": {
                  "type": "array",
          ...
          "409": {
            "description": "O reload não pôde ser executado porque o history sync ainda está em andamento",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
    ...
    "/business/get/profile": {
      "post": {
        ...
        "description": "Retorna o perfil comercial da conta do WhatsApp Business atualmente conectada.\n",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
    ...
    "/business/get/categories": {
      "get": {
        ...
        "description": "Retorna as categorias de negócios disponíveis.\n",
        "responses": {
          "200": {
                  ...
                  "properties": {
                    "response": {
                      ...
                      "properties": {
                        "JID": {
                          "type": "object",
                          "description": "JID do catálogo consultado, serializado pela struct atual do backend.",
                          "properties": {
                            "User": {
                              "type": "string",
                              "example": "5511999999999"
